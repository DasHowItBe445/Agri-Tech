...
getContractFactory(name: 'KrishiPassport', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.KrishiPassport__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'KrishiPassport', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.KrishiPassport>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'KrishiPassport', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.KrishiPassport>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'KrishiPassport', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.KrishiPassport>
